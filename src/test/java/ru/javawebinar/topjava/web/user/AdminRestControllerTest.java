...
class AdminRestControllerTest extends AbstractControllerTest {
    ...
    void updateWithErrors() throws Exception {
        User withErrors = getUpdatedWithValidationErrors();
        perform(MockMvcRequestBuilders.put(REST_URL + USER_ID)
                .contentType(MediaType.APPLICATION_JSON)
                .with(userHttpBasic(admin))
                .content(jsonWithPassword(withErrors, withErrors.getPassword())))
                .andDo(print())
                .andExpect(status().isUnprocessableEntity());
    }
    ...
    void createWithErrors() throws Exception {
        User withErrors = getNewWithValidationErrors();
    ...
    void createWithDuplicateEmail() throws Exception {
        User withErrors = getNew();
        withErrors.setEmail(admin.getEmail());
        perform(MockMvcRequestBuilders.post(REST_URL)
                .contentType(MediaType.APPLICATION_JSON)
                .with(userHttpBasic(admin))
                .content(jsonWithPassword(withErrors, withErrors.getPassword())))
